...
import { environment } from '../../../environments/environment'; // Update path as needed

@Injectable({
  providedIn: 'root'
})
export class SearchService {
  private baseUrl = `${environment.apiUrl}/search`; // Ensure this is pointing to your API base URL correctly
